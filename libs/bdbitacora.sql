...
CREATE TABLE `acta_compromiso` (
  ...
  `acta_Funcionario` varchar(50) DEFAULT NULL COMMENT 'Id del instructor que genera el acta de compromiso',
  ...
  KEY `FK_ACTAS_FUNCIONARIOS` (`acta_Funcionario`),
  ...
  CONSTRAINT `FK_ACTAS_FUNCIONARIOS` FOREIGN KEY (`acta_Funcionario`) REFERENCES `funcionario` (`ID_Func`)
